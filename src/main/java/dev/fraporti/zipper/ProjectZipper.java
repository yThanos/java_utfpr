...
public class ProjectZipper {
    ...
    private static final String OUTPUT = "src/main/resources/output/%s.zip";
    ...
    public static void main(String[] args) {
        ...
        Path output = Paths.get("src/main/resources/output");
        ...
        try(FileOutputStream fos = new FileOutputStream(pathToSave);
            ...
            for (File file : files) {
                //relativePath logic made with help of AI XD
